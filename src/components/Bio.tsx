...
function Bio () {
  ...
  return (
    <div className="grid grid-cols-2 w-[100vw] h-[100vw] lg:flex flex-wrap">
      <motion.div
      ...
      <motion.div className="grid justify-items-center"
          ...
          whileInView={{ opacity: 1 , scale: 1}}
          transition={{ease: [0, 0.71, 0.2, 1.01]}}>
        <img alt="Site" src={Site} className="w-[50%] h-[50%] lg:hidden"></img>
      </motion.div>
      ...
      whileInView={{ opacity: 1 , scale: 1}}
      transition={{ease: [0, 0.71, 0.2, 1.01]}}>
          <img alt="Hora" src={Hora} className="w-[50%] h-[50%] lg:hidden"></img>
        </motion.div>
        <motion.div
        initial={{opacity:0 , scale: 0}}
        whileInView={{ opacity: 1 , scale: 1}}
