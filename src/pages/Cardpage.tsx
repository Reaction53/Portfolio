  ...
  return (
    <div className='flex justify-center w-screen h-[74vw] lg:h-[140vw]'>
      <div>
        ...
        <div style={{ perspective: 2000}} className='flex items-center ml-[-32%] lg:mt-[25%] lg:ml-[20%]'>
          <motion.div
          ...
          className='w-[400px] min-h-[500px] bg-gradient-to-r from-[#0D1212] to-[#060808] text-gray-300 shadow-lg shadow-black rounded-lg px-[40px] py-[25px] cursor-grab relative lg:w-[80%] lg:h-[30%]'>{/*Card*/}
            ...
            <h1 className='text-5xl mb-6 font-extrabold lg:p-30 lg:text-center lg:text-xl'>Cards Animados!</h1>{/*Titulo*/}
            ...
            className='absolute top-[35%] lg:mt-[10%] md:mt-[45%] md:ml-[10%]'>{/*Image*/}
